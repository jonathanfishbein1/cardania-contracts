...
testBuy = Plutus.Contract.Test.checkPredicateOptions
    myOptions
...
initialDistributionClose = 
    ...
    where
        v1 :: Ledger.Value.Value  
        v1 = Ledger.Ada.lovelaceValueOf 100_000_000 PlutusTx.Prelude.<>
...
testsClose = Plutus.Contract.Test.checkPredicateOptions
    myOptions

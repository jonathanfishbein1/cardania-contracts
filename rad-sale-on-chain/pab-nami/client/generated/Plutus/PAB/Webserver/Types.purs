...
instance DecodeJson ChainReport where
  decodeJson = defer \_ -> D.decode $ (ChainReport <$> D.record "ChainReport"
...
instance DecodeJson CombinedWSStreamToClient where
  decodeJson = defer \_ -> D.decode
    $ D.sumType "CombinedWSStreamToClient" $ Map.fromFoldable
...
instance DecodeJson CombinedWSStreamToServer where
  decodeJson = defer \_ -> D.decode
    $ D.sumType "CombinedWSStreamToServer" $ Map.fromFoldable
...
instance (DecodeJson a) => DecodeJson (ContractActivationArgs a) where
  decodeJson = defer \_ -> D.decode $ (ContractActivationArgs <$> D.record "ContractActivationArgs"
      { caID: D.value :: _ a
...
instance (DecodeJson a) => DecodeJson (ContractInstanceClientState a) where
  decodeJson = defer \_ -> D.decode $ (ContractInstanceClientState <$> D.record "ContractInstanceClientState"
...
instance (DecodeJson a) => DecodeJson (ContractReport a) where
  decodeJson = defer \_ -> D.decode $ (ContractReport <$> D.record "ContractReport"
...
instance (DecodeJson a) => DecodeJson (ContractSignatureResponse a) where
  decodeJson = defer \_ -> D.decode $ (ContractSignatureResponse <$> D.record "ContractSignatureResponse"
...
instance (DecodeJson a) => DecodeJson (FullReport a) where
  decodeJson = defer \_ -> D.decode $ (FullReport <$> D.record "FullReport"
...
instance DecodeJson InstanceStatusToClient where
  decodeJson = defer \_ -> D.decode
    $ D.sumType "InstanceStatusToClient" $ Map.fromFoldable

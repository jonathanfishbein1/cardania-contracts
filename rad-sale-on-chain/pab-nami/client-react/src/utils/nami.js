import * as CardanoWasm from 'nami-wallet/temporary_modules/@emurgo/cardano-serialization-lib-browser'
...
export async function balanceTxImpl(cbor) {
  return await exports.balanceTxImpl(cbor)()
}
